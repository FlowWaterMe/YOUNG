...
/* get function: DataLogger5 */
#ifndef TOLUA_DISABLE_tolua_get_DataLogger_ptr
static int tolua_get_DataLogger_ptr(lua_State* tolua_S)
{
   tolua_pushusertype(tolua_S,(void*)DataLogger5,"CDataLogger");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: DataLogger5 */
...
#endif
  DataLogger5 = ((CDataLogger*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_DataLogger5_open (lua_State* tolua_S)
{
 ...
 TOLUA_API int luaopen_DataLogger5 (lua_State* tolua_S) {
 return tolua_DataLogger5_open(tolua_S);
};
#endif
