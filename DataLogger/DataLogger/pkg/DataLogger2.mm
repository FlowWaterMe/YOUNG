...
/* get function: DataLogger2 */
#ifndef TOLUA_DISABLE_tolua_get_DataLogger_ptr
static int tolua_get_DataLogger_ptr(lua_State* tolua_S)
{
   tolua_pushusertype(tolua_S,(void*)DataLogger2,"CDataLogger");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: DataLogger2 */
...
#endif
  DataLogger2 = ((CDataLogger*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_DataLogger2_open (lua_State* tolua_S)
{
 ...
 TOLUA_API int luaopen_DataLogger2 (lua_State* tolua_S) {
 return tolua_DataLogger2_open(tolua_S);
};
#endif
