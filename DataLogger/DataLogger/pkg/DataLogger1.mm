/*
** Lua binding: DataLogger1
** Generated automatically by tolua++-1.0.92 on Tue Jun 10 13:20:29 2014.
*/
...
/* get function: DataLogger1 */
#ifndef TOLUA_DISABLE_tolua_get_DataLogger_ptr
static int tolua_get_DataLogger_ptr(lua_State* tolua_S)
{
   tolua_pushusertype(tolua_S,(void*)DataLogger1,"CDataLogger");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: DataLogger1 */
...
#endif
  DataLogger1 = ((CDataLogger*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_DataLogger1_open (lua_State* tolua_S)
{
 ...
 TOLUA_API int luaopen_DataLogger1 (lua_State* tolua_S) {
 return tolua_DataLogger1_open(tolua_S);
};
#endif
