...
/* get function: DataLogger3 */
#ifndef TOLUA_DISABLE_tolua_get_DataLogger_ptr
static int tolua_get_DataLogger_ptr(lua_State* tolua_S)
{
   tolua_pushusertype(tolua_S,(void*)DataLogger3,"CDataLogger");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: DataLogger3 */
...
#endif
  DataLogger3 = ((CDataLogger*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_DataLogger3_open (lua_State* tolua_S)
{
 ...
 TOLUA_API int luaopen_DataLogger3 (lua_State* tolua_S) {
 return tolua_DataLogger3_open(tolua_S);
};
#endif
