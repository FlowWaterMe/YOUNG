...
/* get function: DataLogger4 */
#ifndef TOLUA_DISABLE_tolua_get_DataLogger_ptr
static int tolua_get_DataLogger_ptr(lua_State* tolua_S)
{
   tolua_pushusertype(tolua_S,(void*)DataLogger4,"CDataLogger");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: DataLogger4 */
...
#endif
  DataLogger4 = ((CDataLogger*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_DataLogger4_open (lua_State* tolua_S)
{
 ...
 TOLUA_API int luaopen_DataLogger4 (lua_State* tolua_S) {
 return tolua_DataLogger4_open(tolua_S);
};
#endif
