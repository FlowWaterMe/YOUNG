...
/* get function: TestContext5 */
#ifndef TOLUA_DISABLE_tolua_get_TestContext_ptr
static int tolua_get_TestContext_ptr(lua_State* tolua_S)
{
   tolua_pushusertype(tolua_S,(void*)TestContext5,"CTestContext");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: TestContext5 */
...
#endif
  TestContext5 = ((CTestContext*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_Global_Variant6_open (lua_State* tolua_S)
{
 ...
 TOLUA_API int luaopen_Global_Variant6 (lua_State* tolua_S) {
 return tolua_Global_Variant6_open(tolua_S);
};
#endif
