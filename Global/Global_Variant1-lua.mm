...
/* get function: TestContext0 */
#ifndef TOLUA_DISABLE_tolua_get_TestContext_ptr
static int tolua_get_TestContext_ptr(lua_State* tolua_S)
{
   tolua_pushusertype(tolua_S,(void*)TestContext0,"CTestContext");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: TestContext0 */
...
#endif
  TestContext0 = ((CTestContext*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_Global_Variant1_open (lua_State* tolua_S)
{
 ...
 TOLUA_API int luaopen_Global_Variant1 (lua_State* tolua_S) {
 return tolua_Global_Variant1_open(tolua_S);
};
#endif
